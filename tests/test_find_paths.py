...
def test_find_paths():
    ...
    assert get_paths(ini_dict, keys_list) == ['  roster1.  player1.- lastname', '  roster1.  player1.- sport', '  roster1.  player0.+ sports', '  roster1.  player1.- lastname', '  roster1.  player1.- sport', '  roster1.  player1.+ sport', '  roster1.  player1.+ surname', '  roster2.  player0.- firstname', '  roster2.  player0.+ firstname', '  roster2.- player1', '  roster2.+ toto']
