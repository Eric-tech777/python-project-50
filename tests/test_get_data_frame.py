...
def test_get_data_frame():
    ...
    assert get_data_frame(merged_list) == ["Property 'roster1.player1.lastname' was removed", "Property 'roster1.player1.sport' was removed", "Property 'roster1.player0.sports' was added with value: 'NFL'", "Property 'roster1.player1.lastname' was removed", "Property 'roster1.player1.sport' was updated. From 'NFL' to 'NFLO'", "Property 'roster1.player1.surname' was added with value: 'Miller'", "Property 'roster2.player0.firstname' was updated. From 'Carson' to 'Carlson'", "Property 'roster2.player1' was removed", "Property 'roster2.toto' was added with value: [complex value]"]
