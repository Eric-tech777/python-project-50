...
def test_get_values():
    ...
    assert get_list_of_values(ini_dict) == ['Taylor', 'NFL', 'NFL', 'Miller', 'NFL', 'NFLO', 'Miller', 'Carson', 'Carlson', {'firstname': 'David', 'lastname': 'Johnson', 'sport': 'NFL'}, {'company': 'Davidoff', 'lastname': 'Johnson', 'sport': 'NFL'}]
